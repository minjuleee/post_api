...
from app.schemas.post_schema import (
  PostCreate, PostDetail, PostListResponse, PostUpdate,
  PostCreateWithAttachment, PostDetailWithStat
)
...
@router.post("/with-files", response_model=PostDetailWithStat, summary="게시글 + 통계 + 첨부파일 등록")
...
@router.get("/with-stat/{id}", response_model=PostDetailWithStat, summary="게시글 상세 + 통계 + 첨부파일 조회")
